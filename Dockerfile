...
RUN apt-get install -y re2c bison libxml2-dev libcurl4-openssl-dev libjpeg62-turbo-dev libpng12-dev libmcrypt-dev libreadline-dev libtidy-dev libxslt1-dev imagemagick autoconf
